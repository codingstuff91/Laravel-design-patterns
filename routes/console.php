...
use App\Patterns\Behavioral\Strategy\TransportCostEstimator\TransportCostEstimator;
...
//    $result = (new App())->log();
    ...
    $calculateTravelCost = (new TransportCostEstimator)->calculateCost(new Bus());
